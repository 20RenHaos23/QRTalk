    ...
    function tevt(diss) {
        if ($('#distance').value != 0) {
            ...
            $.ajax({
                ...
                url: "../php_vi/gps_check.php", //目標給哪個檔案 同 form 的 action 屬性
                ...
                if (data == "yes") {
                    ...
                    window.location.href = "https://cs.ee.nchu.edu.tw<?php echo dirname($_SERVER['PHP_SELF']); ?>/qrcoddde.php?id=<?php echo base64_encode($datas['id']); ?>";
                } else {
                    //console.log(data);
                    alert("太遠了！");
