...
if (isset($_SESSION['is_login_vi']) && $_SESSION['is_login_vi']) {
    ...
    header("Location: ../admin_vi/index_vi.php");
}
?>
<!DOCTYPE html>
<html lang="zh-TW">
...
<body>
    ...
    <div class="jumbotron">
        <div class="container">
            <div class="row">
                <div class="col-xs-12">
                    <h1 class="text-center">QR Talk透天登入</h1>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $("form#login_form").on("submit", function() {
                ...
                $.ajax({
                    type: "POST",
                    url: "php_vi/verify_user.php", //因為此 login.php 是放在 admin 資料夾內，若要前往 php，就要回上一層 ../ 找到 php 才能進入 verify_user.php
                    data: {
                    ...
                    if (data == "yes") {
                        //註冊新增成功，轉跳到登入頁面。
                        window.location.href = "admin_vi/index_vi.php"; //因為目前的 login.php 跟後端的 index.php 首頁在同一資料夾，所以直接叫他就好
                    } else {
                        alert("登入失敗，請確認帳號密碼");
