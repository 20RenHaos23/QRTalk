...
//$datas = get_id_family(base64_decode($_GET['id'])); //取得住戶裡面的聯絡人資料，顯示在住戶首頁

$datas = get_id_family(base64_decode($_GET['id'])); //取得住戶裡面的聯絡人資料，顯示在住戶首頁
//print_r($datas);
if (!isset($_SESSION['inside_dis_god_cod']) || !$_SESSION['inside_dis_god_cod']) {
    //直接轉跳到 login.php
...
<?php
unset($_SESSION['inside_dis_god_cod']);
