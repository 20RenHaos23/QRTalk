...
$family_datas = get_id_family($_SESSION['login_vi_id']); //取得使用者裡面的聯絡人資料，顯示在使用者首頁
...
<body>
      ...
      <div class="row">
        ...
        <div class="col-xs-12">
          ...
          <div class="text-center">
            <a href='https://cs.ee.nchu.edu.tw<?php echo dirname(dirname($_SERVER['PHP_SELF'])); ?>/admin_vi/gps.php?id=<?php echo base64_encode($datas['id']); ?>' target="_blank">
              <div id="qrcode"></div>
            </a>
          </div>
        </div>
  ...
  <script>
    $('#qrcode').qrcode({
      text: 'https://cs.ee.nchu.edu.tw<?php echo dirname(dirname($_SERVER['PHP_SELF'])); ?>/admin_vi/gps.php?id=<?php echo base64_encode($datas['id']); ?>'
    });
  </script>
  <script>
    //當文件準備好時，
