                ...
                <div class="col-xs-12">
                    <form id="familylink">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="InputName" placeholder="請輸入聯絡人名稱or暱稱">
                        </div>
                        <div class="form-group">
        ...
        $(document).ready(function() {
            ...
            $("form#familylink").on("submit", function() {
                if ($("#InputName").val() == '' || $("#InputLink").val() == '') {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "../php_pe/add_family.php", //因為此 login.php 是放在 admin 資料夾內，若要前往 php，就要回上一層 ../ 找到 php 才能進入 verify_user.php
                        data: {
